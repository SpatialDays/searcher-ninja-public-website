      ...
      <div className="wrapper">
        <div className="container-who">
          <div className="ninja-container">
            <JapText text="Who We Are" fontSize="70px" />
          ...
          <div className="text-container">
            <p className="clear-font">
              <span className=" ">Searcher Ninja</span> is a brand name created
              by{" "}
              <a
                target="_blank"
                className="cool-font "
              ...
              one search engine), response times (advertised latency figures are
              clearly fictional) or cost (some services were deemed to be
              expensive).
              <br />
              <br />
              ...
              <a
                target="_blank"
                className="cool-font "
                href="http://service.searcher.ninja"
              >
                RapidAPI
              </a>
              .
              ...
              <i>
                ...
                product or service needs to be much better than theirs. It can't
                be a little bit better, because then you put yourself in the
                shoes of the consumer... you're always going to buy the trusted
                brand unless there's a big difference.
              </i>
              ” - Elon Musk
              <br />
              <br />
